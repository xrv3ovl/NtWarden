...
namespace WinSys {
	...
	struct ProcessInfo {
		...
		// For remote data population
		void SetProcessName(const std::wstring& name) { _processName = name; }
		void SetNativeImagePath(const std::wstring& path) { _nativeImagePath = path; }
