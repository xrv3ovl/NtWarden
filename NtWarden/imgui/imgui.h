...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsRedSamurai(ImGuiStyle* dst = NULL);    // custom, red samurai style
...
enum ImGuiTabBarFlags_
{
    ...
    ImGuiTabBarFlags_FittingPolicyWrap              = 1 << 8,   // Wrap tabs to multiple rows when they don't fit
    ImGuiTabBarFlags_FittingPolicyMask_             = ImGuiTabBarFlags_FittingPolicyResizeDown | ImGuiTabBarFlags_FittingPolicyScroll | ImGuiTabBarFlags_FittingPolicyWrap,
