...
struct ImGuiTabItem
{
    ...
    ImS16               Row;                    // Row index when using FittingPolicyWrap

    ImGuiTabItem()      { memset(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; RequestedWidth = -1.0f; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; Row = 0; }
};
...
struct IMGUI_API ImGuiTabBar
{
    ...
    ImS16               NumRows;                // Number of rows when using FittingPolicyWrap (1 = no wrapping)
